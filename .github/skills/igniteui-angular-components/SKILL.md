...
- If Ignite UI for Angular is not installed, it can be added via `ng add igniteui-angular`, **or** `ng add @infragistics/igniteui-angular` for licensed users — both packages share the same entry-point structure
